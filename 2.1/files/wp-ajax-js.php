...
Object.extend(WPAjax.prototype, {
	...
	initialize: function(url, responseEl) {
		...
		this.url = url ? url : 'admin-ajax.php';
	...
	parseAjaxResponse: function() { // 1 = good, 0 = strange (bad data?), -1 = you lack permission
		...
		var r = parseInt(r,10);
		if ( -1 == r ) {
			Element.update(this.myResponseElement,"<div class='error'><p>You don't have permission to do that.</p></div>");
			return false;
		} else if ( 0 == r ) {
			Element.update(this.myResponseElement,"<div class='error'><p>Something strange happened.  Try refreshing the page.</p></div>");
			return false;
		}
		return true;
	},

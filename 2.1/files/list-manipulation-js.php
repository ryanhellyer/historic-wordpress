...
function deleteSomething(what,id,message,obj){if(!obj)obj=theList;if(!message)message="Are you sure you want to delete this '+what+'?";if(confirm(message))return obj.ajaxDelete(what,id);else return false;}
			...
			if ( newItems ) {
				...
				newItems.each( function(i) {
					...
					if ( m )
						...
						showLinkMessage += "<a href='#" + what + '-' + id + "'>Jump to new item";
				});
